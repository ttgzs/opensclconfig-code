...
namespace IEC61850
{
  namespace SCL
  {
    namespace Validation
    {
      class SCL_pskel: public virtual ::IEC61850::SCL::Validation::tBaseElement_pskel
      {
        public:
        ...
        //
        void
        Header_parser (::IEC61850::SCL::Validation::tHeader_pskel&);

        void
        Substation_parser (::IEC61850::SCL::Validation::tSubstation_pskel&);

        void
        Communication_parser (::IEC61850::SCL::Validation::tCommunication_pskel&);

        void
        IED_parser (::IEC61850::SCL::Validation::tIED_pskel&);

        void
        DataTypeTemplates_parser (::IEC61850::SCL::Validation::tDataTypeTemplates_pskel&);
        ...
        protected:
        ::IEC61850::SCL::Validation::tHeader_pskel* Header_parser_;
        ::IEC61850::SCL::Validation::tSubstation_pskel* Substation_parser_;
        ::IEC61850::SCL::Validation::tCommunication_pskel* Communication_parser_;
        ::IEC61850::SCL::Validation::tIED_pskel* IED_parser_;
        ::IEC61850::SCL::Validation::tDataTypeTemplates_pskel* DataTypeTemplates_parser_;

        protected:
        struct v_state_descr_
        {
          void (::IEC61850::SCL::Validation::SCL_pskel::*func) (
            unsigned long&,
            unsigned long&,
            const ::xml_schema::ro_string&,
            const ::xml_schema::ro_string&,
