...
#ifndef SCL_BASE_TYPES_H
#define SCL_BASE_TYPES_H
...
namespace IEC61850
{
  namespace SCL
  {
    class tBaseElement: public ::xml_schema::type
    {
      ...
      // Text
      // 
      typedef ::IEC61850::SCL::tText Text_type;
      ...
      // Private
      // 
      typedef ::IEC61850::SCL::tPrivate Private_type;
    ...
    class tUnNaming: public ::IEC61850::SCL::tBaseElement
    {
      public:
      // desc
      // 
    ...
    class tNaming: public ::IEC61850::SCL::tBaseElement
    {
      public:
      // name
      // 
      typedef ::IEC61850::SCL::tName name_type;
    ...
    class tIDNaming: public ::IEC61850::SCL::tBaseElement
    {
      public:
      // id
      // 
      typedef ::IEC61850::SCL::tName id_type;
    ...
    class tText: public ::IEC61850::SCL::tAnyContentFromOtherNamespace
    {
      public:
      // source
      // 
    ...
    class tPrivate: public ::IEC61850::SCL::tAnyContentFromOtherNamespace
    {
      public:
      // type
      // 
    ...
    class tHeader: public ::xml_schema::type
    {
      ...
      // History
      // 
      typedef ::IEC61850::SCL::History History_type;
      ...
      // nameStructure
      // 
      typedef ::IEC61850::SCL::nameStructure nameStructure_type;
    ...
    class tHitem: public ::IEC61850::SCL::tAnyContentFromOtherNamespace
    {
      public:
      // version
      // 
    ...
    class tValueWithUnit: public ::xsd::cxx::tree::fundamental_base< ::xml_schema::decimal, char, ::xml_schema::simple_type, ::xsd::cxx::tree::schema_type::decimal >
    {
      ...
      // unit
      // 
      typedef ::IEC61850::SCL::tSIUnitEnum unit_type;
      ...
      // multiplier
      // 
      typedef ::IEC61850::SCL::tUnitMultiplierEnum multiplier_type;
    ...
    class tVoltage: public ::IEC61850::SCL::tValueWithUnit
    {
      public:
      // Constructors.
      //
    ...
    class tBitRateInMbPerSec: public ::IEC61850::SCL::tValueWithUnit
    {
      public:
      // Constructors.
      //
    ...
    class tDurationInSec: public ::IEC61850::SCL::tValueWithUnit
    {
      public:
      // Constructors.
      //
    ...
    class tDurationInMilliSec: public ::IEC61850::SCL::tValueWithUnit
    {
      public:
      // Constructors.
      //
    ...
    class History: public ::xml_schema::type
    {
      ...
      // Hitem
      // 
      typedef ::IEC61850::SCL::tHitem Hitem_type;
...
namespace IEC61850
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const tBaseElement&);

    void
    operator<< (::xercesc::DOMElement&, const tUnNaming&);

    void
    operator<< (::xercesc::DOMElement&, const tNaming&);

    void
    operator<< (::xercesc::DOMElement&, const tIDNaming&);

    void
    operator<< (::xercesc::DOMElement&, const tAnyContentFromOtherNamespace&);

    void
    operator<< (::xercesc::DOMElement&, const tText&);

    void
    operator<< (::xercesc::DOMElement&, const tPrivate&);

    void
    operator<< (::xercesc::DOMElement&, const tHeader&);

    void
    operator<< (::xercesc::DOMElement&, const tHitem&);

    void
    operator<< (::xercesc::DOMElement&, const tVal&);

    void
    operator<< (::xercesc::DOMElement&, const tValueWithUnit&);

    void
    operator<< (::xercesc::DOMElement&, const tVoltage&);

    void
    operator<< (::xercesc::DOMElement&, const tBitRateInMbPerSec&);

    void
    operator<< (::xercesc::DOMElement&, const tDurationInSec&);

    void
    operator<< (::xercesc::DOMElement&, const tDurationInMilliSec&);

    void
    operator<< (::xercesc::DOMElement&, const History&);

    void
    operator<< (::xercesc::DOMElement&, const nameStructure&);

    void
    operator<< (::xercesc::DOMAttr&, const nameStructure&);
