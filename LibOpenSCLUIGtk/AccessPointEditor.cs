...
namespace LibOpenSCLUIGtk
{
	...
	public partial class AccessPointEditor : Gtk.Bin
	{
		...
		public AccessPointEditor ()
		{
			this.Init();
		}
		
		public AccessPointEditor (OpenSCL.Object sclfile, int iedIndex, int apIndex)
		{
			this.Init();
