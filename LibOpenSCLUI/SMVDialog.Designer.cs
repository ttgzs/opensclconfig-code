...
namespace OpenSCL.UI
{
	partial class SMVDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox1.Controls.Add(this.appcopyright);
			...
			// label4
			// 
			this.appcopyright.Location = new System.Drawing.Point(10, 111);
			this.appcopyright.Name = "label4";
			this.appcopyright.Size = new System.Drawing.Size(100, 23);
			this.appcopyright.TabIndex = 3;
			this.appcopyright.Text = "Application ID:";
			// 
			// label3
			// 
			this.appdesc.Location = new System.Drawing.Point(14, 72);
			this.appdesc.Name = "label3";
			this.appdesc.Size = new System.Drawing.Size(100, 23);
			this.appdesc.TabIndex = 2;
			this.appdesc.Text = "MAC Address:";
			// 
			// label1
			// 
